...
async function obtenerClimaCartagena() {
    const ciudad = 'Cartagena de Indias, Bolívar, Colombia';

    resultadoClimaDiv.innerHTML = '<p>Cargando clima de Cartagena...</p>';
...
// Puedes llamar esta función automáticamente al cargar la página o desde un botón
document.addEventListener('DOMContentLoaded', obtenerClimaCartagena);
